...
/**
 * First step after “Start consultation”: sets expectations, then links to `/consult/intake`.
 */
                ...
                <div className="col-span-12 lg:col-span-6 min-w-0">
                  ...
                  <div className="mt-10">
                    ...
                    <p className="mt-4 text-[11px] text-on-surface/45">
                      ...
                      <a className="underline underline-offset-[5px] decoration-on-surface/20 hover:text-primary" href="/privacy">
                        privacy policy
                      </a>{" "}
                      and{" "}
                      <a className="underline underline-offset-[5px] decoration-on-surface/20 hover:text-primary" href="/terms">
                        terms
                      </a>
                      .
                    </p>
                  ...
                  <div className="mx-auto flex w-full max-w-[360px] flex-col gap-8 lg:max-w-[380px] lg:ml-auto lg:mr-0">
                    <div className="rounded-2xl border border-outline-variant/15 bg-surface/95 px-5 py-4 shadow-[0_20px_50px_-28px_rgba(47,51,48,0.35)] backdrop-blur-md">
                      ...
                      <p className="mt-3 text-xs italic leading-relaxed text-on-surface-variant">
                        “we treat skin as something that changes week to week. this assessment helps us meet
                        you where you are—not where a trend says you should be.”
                      </p>
                    </div>
